...
from fastapi_proj.apps.auth.depends import get_current_user
from fastapi_proj.apps.auth.schemas import AuthUser, UserReturnData, UserVerifySchema
from fastapi_proj.apps.auth.services import UserService
