...
from fastapi_proj.core.core_dependency.db_dependency import DBDependency
from fastapi_proj.core.core_dependency.redis_dependency import RedisDependency
from fastapi_proj.database.models import User
